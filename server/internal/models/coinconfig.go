...
type CoinConfig struct {
	...
	ChainName     string         `gorm:"type:varchar(20);not null;index:idx_coin_config_chain_status,priority:1;column:chain_name;comment:链名称" json:"chain_name"`
	...
	Status        int8           `gorm:"type:tinyint(3);not null;default:1;index:idx_coin_config_chain_status,priority:2;column:status;comment:状态: 0=禁用, 1=启用" json:"status"`
