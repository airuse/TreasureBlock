...
type TransactionReceipt struct {
	...
	TxHash          string `json:"tx_hash" gorm:"index;size:66;not null;comment:交易哈希"`
	...
	// 新增关键字段（用于以太坊Receipts Trie重建）
	CumulativeGasUsed string `json:"cumulative_gas_used" gorm:"size:100;comment:累计Gas使用量(支持16进制字符串)"`
	...
	BlockID          uint64         `json:"block_id" gorm:"index;comment:关联的区块ID"`
