...
const recentActivities = ref([
  {
    id: 1,
    type: 'earnings',
    description: '扫块成功，获得 0.3 TB 收益',
    timestamp: new Date(Date.now() - 1000 * 60 * 30) // 30分钟前
  },
  {
    id: 2,
    type: 'transaction',
    description: '交易 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa 已确认',
    timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2) // 2小时前
  },
  {
    id: 3,
    type: 'address',
    description: '新增地址 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
...
const loadData = async () => {
  // TODO: 从API加载真实数据
  totalEarnings.value = 8.2
  addressCount.value = 2
  pendingTransactions.value = 1
  completedTransactions.value = 12
}
