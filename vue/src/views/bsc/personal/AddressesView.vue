    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg leading-6 font-medium text-gray-900">BSC地址列表</h3>
          <button
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4">
          ...
          <div class="px-6 py-4">
            <div class="space-y-4">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">金额 (BNB)</label>
                <input
