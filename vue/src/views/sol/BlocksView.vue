<template>
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <h1 class="text-2xl font-bold text-gray-900">Solana 区块列表</h1>
            ...
            <template v-for="block in blocks" :key="block.height">
              <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                  <router-link :to="`/sol/blocks/${block.height}`" class="text-blue-600 hover:text-blue-700 font-medium">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <div>
                    <div class="font-medium">{{ formatMinerTip(block.miner_tip_eth) }} SOL</div>
...
// WebSocket集成
const { subscribeChainEvent, unsubscribeChainEvent, isConnected } = useChainWebSocket('sol')
