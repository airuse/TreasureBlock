<template>
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <h1 class="text-2xl font-bold text-gray-900">Solana 系统合约地址管理</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="address in addresses" :key="address.hash" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center space-x-2">
                  <router-link :to="`/sol/addresses/${address.hash}`" class="text-blue-600 hover:text-blue-700 font-mono text-sm">
                    {{ address.hash }}
                  </router-link>
                  <button 
